...
double kNavBarPersistentHeight = kMinInteractiveDimensionCupertino;
...
class CustomCupertinoNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  ...
  CustomCupertinoNavigationBar({
    ...
    this.heroTag = _defaultHeroTag,
        ...
        super(key: key){
    if(this.height == null){
      this.height = kNavBarPersistentHeight;
...
class _CustomCupertinoNavigationBarState extends State<CustomCupertinoNavigationBar> {
